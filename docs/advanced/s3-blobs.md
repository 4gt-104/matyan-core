...
- [Backend](backend.md) — Fetches blobs from S3 for API responses.
- [Workers](workers.md) — Control worker performs S3 cleanup; ingestion worker writes blob refs to FDB.
